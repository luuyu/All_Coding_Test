...
int main() {
    ...
    cout << (testString.rfind('a',40) == testMyString.rfind('a',40)) << endl <<endl;
    ...
    cout << (testString.rfind('0',40) == testMyString.rfind('0',40)) << endl << endl;
    ...
    cout << (testString.rfind('8',40) == testMyString.rfind('8',40)) << endl <<endl;
    ...
    cout << (testString.rfind('9',40) == testMyString.rfind('9',40)) << endl << endl;
    ...
    cout << (testString.rfind("",40) == testMyString.rfind("",40)) << endl << endl;
    ...
    cout << (testString.rfind("018",40) == testMyString.rfind("018",40)) << endl << endl;
    ...
    cout << (testString.rfind("648",40) == testMyString.rfind("648",40)) << endl << endl;
    ...
    cout << (testString.rfind("012",40) == testMyString.rfind("012",40)) << endl << endl;
    ...
    cout << (testString.rfind("890",40) == testMyString.rfind("890",40)) << endl << endl;;
    ...
    cout << (testString.rfind("789",40) == testMyString.rfind("789",40)) << endl <<endl;
    ...
    //cout << "m : "<<emptyString.rfind('0'   )<< endl;
    //cout << "em : "<<emptyMyString.rfind('0'   )<< endl;
